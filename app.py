...
def fetch_poster(music_title):
    ...
    data = response.json()
    return data['data']['results'][3]['image'][2]['url']
...
music_dict = pickle.load(open(r'D:\document\music_recommended_system\musicrec.pkl', 'rb'))
music = pd.DataFrame(music_dict)

similarity = pickle.load(open(r'D:\document\music_recommended_system\similarities.pkl', 'rb'))
